...
update_shell() {
    wget -O /usr/bin/x-ui -N --no-check-certificate https://github.com/wangxiaoke122/x-ui-alpine/raw/master/x-ui-2.sh
    if [[ $? != 0 ]]; then
        echo ""
